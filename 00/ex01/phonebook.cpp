...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/06/01 08:22:22 by yeonhlee          #+#    #+#             */
/*   Updated: 2021/06/01 08:47:50 by yeonhlee         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::string	Phonebook::input_data(const std::string data_name)
{
...
void	Phonebook::index_list(int i)
{
...
void	Phonebook::print_data_list(int i)
{
...
bool	Phonebook::check_input(std::string input, int i)
{ 
	if (i == 0)
	{
		if (input.size() != 1)
